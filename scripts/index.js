...
function initApp() {
    ...
    quiz = new Quiz(
        "Technical Assessment MCQ",
        `There are 7 MCQ questions in this assessment and you have to answer all those questions . The time given to solve these questions in 70 seconds `,
        70,
        questions);
